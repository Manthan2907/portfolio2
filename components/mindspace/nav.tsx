      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span
              className="font-serif text-xl font-semibold text-foreground tracking-tight group-hover:opacity-80 transition-opacity"
            >
              MindSpace
            </span>
          </Link>
          ...
          >
            <nav className="flex flex-col gap-1 pb-2" aria-label="Mobile navigation">
              ...
              <div className="flex flex-col gap-2 mt-2 px-1">
                <Link
                  href="#signin"
                  className="py-2.5 rounded-xl text-sm text-center text-muted-foreground hover:text-foreground border border-white/10 transition-all"
                >
                  Sign in
                </Link>
                <Link
